...
SYNOPSIS
    IRIS_waveform <event_list> [-s <station_specs>] [-t <twin_specs>] [-o <out_dir>]

DESCRIPTION
    <event_list>    a catalog list generated by fdsnws-event with catalog=GCMT 
    -s <station_specs> [b/20/60/90/150]
        box region: b/lat0/lat1/lon0/lon1
        radial region: r/lat0/lon0/radius0/radius1
    -t <twin_specs> [p,P/-300/1500]
